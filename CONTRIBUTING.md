...
3. Increase the version numbers in any examples files, the [package.json](package.json), and the [version.rb](lib/adventure_namer/version.rb) files to the new version that this Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
